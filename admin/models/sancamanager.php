 ...
 * HelloWorld Model
 */
class SancaManagerModelSancaManager extends JModelAdmin
{
        /**
	 ...
	 * @since	1.6
	 */
	public function getTable($type = 'SancaManager', $prefix = 'SancaManagerTable', $config = array()) 
	{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_sancamanager.sancamanager', 'sancamanager', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) 
		{
			return false;
		}
	...
	protected function loadFormData() 
	{
		...
		$data = JFactory::getApplication()->getUserState('com_sancamanager.edit.sancamanager.data', array());
		if (empty($data)) 
		{
			$data = $this->getItem();
		}
